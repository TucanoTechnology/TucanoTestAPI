...
reads every document of the target tree back through its `GET` route, checks
...
`GET /auth/me`, and confirms a guarded write with an under-privileged token answers `403 forbidden`.
